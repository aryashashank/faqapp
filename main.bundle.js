...
module.exports = "<div class=\"card\">\n<div class=\"card-header\">\n\n  Add Bew FAQ\n</div>\n<div class=\"card-block\">\n<form (submit)=\"addQuestion()\">\n<div class=\"form-group\">\n  <label for=\"text\">Question</label>\n  <input type=\"text\" name=\"text\" class=\"form-control\" [(ngModel)]=\"text\">\n</div>\n<div class=\"form-group\">\n  <label for=\"answer\">Answer</label>\n  <input type=\"text\" name=\"answer\" class=\"form-control\" [(ngModel)]=\"answer\">\n</div>\n<input type=\"submit\" value=\"Submit\" class=\"btn btn-primary\">\n</form>\n\n</div>\n</div>"
...
module.exports = "<div class=\"question\">\n  <div class=\"card\">\n    <div class=\"card-header\">\n      {{ question.text }} <a class=\"btn btn-link\" (click)=\"question.hide = !question.hide\">Show</a> | <a class=\"btn btn-link\" (click)=\"removeQuestion(question)\">Remove</a>   \n    </div>\n    <div class=\"card-block\" [hidden]=\"question.hide\">\n      <p class=\"card-text\">{{ question.answer }}</p>\n    </div>\n  </div>\n  <br>\n</div>"
